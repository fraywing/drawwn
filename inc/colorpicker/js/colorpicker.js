	...
	var ColorPicker = function () {
		var
			...
			downIncrement = function (ev) {
				...
				$(document).bind('mouseup touchend', current, upIncrement);
				$(document).bind('mousemove touchmove', current, moveIncrement);
			},
			...
			upIncrement = function (ev) {
				...
				$(document).unbind('mouseup touchend', upIncrement);
				$(document).unbind('mousemove touchmove', moveIncrement);
				return false;
			},
			downHue = function (ev) {
				var current = {
